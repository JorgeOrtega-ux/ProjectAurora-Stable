...
function getSectionFromUrl() {
    ...
    // [FIX] Detectar patrones dinámicos para chats (Deep Linking)
    // Soporta /c/uuid (comunidad) y /c/uuid/uuid (canal específico)
...
async function showSection(sectionName, pushState = true) {
    ...
    // Pasar la sección completa (incluyendo dm/xyz o c/comm/channel) al loader
